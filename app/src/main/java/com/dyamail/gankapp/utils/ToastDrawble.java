package com.dyamail.gankapp.utils;
...
public class ToastDrawble {
    ...
    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(Utils.getContext(), message, getDrawable(Utils.getContext(), R.mipmap.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(Utils.getContext(), message, getDrawable(Utils.getContext(), R.mipmap.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(Utils.getContext(), message, getDrawable(Utils.getContext(), R.mipmap.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(Utils.getContext(), message, getDrawable(Utils.getContext(), R.mipmap.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
...
//    //===========================================常规方法============================================
    ...
    public static void showToast( int resId, int duration) {
        showToast(Utils.getContext().getString(resId), duration);
    }
    //===========================================Toast 替代方法======================================
    ...
    public static void showToast(String msg, int duration) {
        if (mToast == null) {
            mToast = Toast.makeText(Utils.getContext(), msg, duration);
        } else {
            mToast.setText(msg);
        }
        mToast.show();
